...
train_data = 'SkimmedCS_ch3_train.root'
test_data = 'SkimmedCS_ch3_test.root'
...
general_options.m_treename = "B0_ch3"
general_options.m_identifier = "MVAFastBDT_ch3.root"
...
# Train a MVA method and store the weightfile (MVAFastBDT_ch3.root) locally.
